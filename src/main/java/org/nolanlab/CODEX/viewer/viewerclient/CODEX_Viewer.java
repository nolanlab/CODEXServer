...
import org.nolanlab.CODEX.viewer.viewerclient.cal.ChannelCalibration;
import org.nolanlab.CODEX.viewer.viewerclient.cal.ChannelDisplayProperties;
    ...
    public void run(String arg) {
        ...
        if (name!=null) {
            ...
            if (imp!=null) {
                ...
                MultiCompositeImage i5d = new MultiCompositeImage(title+"_reordered", imp2.getStack(), imp.getNChannels()*imp.getNFrames(),imp.getNSlices(), 1);
                ...
                // Read MetaData, if image is an RemoteImage5D
                ...
                if (description!=null && description.length()>=7 && description.startsWith("ImageJ")) {
                    ...
                    if(props.getProperty("RemoteImage5D",null)!=null) {
